    ...
    <Layout>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-brand-navy">Welcome to Covenant Care Services</h2>
          <p className="mt-6 text-lg text-brand-navy/80 leading-relaxed">
          ...
          <p className="mt-4 text-lg text-brand-navy/80 leading-relaxed">
      ...
      <section id="about" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-brand-navy">About Us</h2>
          <p className="mt-6 text-lg text-brand-navy/80 leading-relaxed">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between gap-6 flex-wrap">
            <h2 className="text-3xl sm:text-4xl font-bold text-brand-navy">Our PCA Services Overview</h2>
            <a
              href="/services"
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <ul className="mt-6 space-y-3 text-brand-navy/80">
                {[
                  'Bathing',
                  'Grooming',
                  'Dressing',
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={step.title} className="bg-gray-50 rounded-2xl p-8 shadow-sm">
                ...
                <p className="mt-3 text-brand-navy/80 leading-relaxed">{step.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-brand-navy">Our Staff</h2>
          <p className="mt-6 text-lg text-brand-navy/80 leading-relaxed">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 text-gray-200">
            ...
            <p>Email: contact@covenantcareservices.org</p>
          </div>
        </div>
      </section>
    </Layout>
